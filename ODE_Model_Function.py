...
def solve_pressure_ode(f, t0, t1, dt, x0, pars, future_prediction = False,):
...
if __name__ == "__main__":
	...
	t1,x1 = solve_pressure_ode(ode_pressure_model, t[0], t[-1], 0.25, -0.20629999999999882, pars = [0, 0, p[0], p[1], p[2], p[3]])
	t2,x2 = solve_pressure_ode(ode_pressure_model, t0 = t[-1], t1 = 2050, dt = 0.25, x0 = x1[-1], pars = [0, 0, p[0], p[1], p[2], p[3]], future_prediction = 10000)
	t3,x3 = solve_pressure_ode(ode_pressure_model, t0 = t[-1], t1 = 2050, dt = 0.25, x0 = x1[-1], pars = [0, 0, p[0], p[1], p[2], p[3]], future_prediction = 0)
	t4,x4 = solve_pressure_ode(ode_pressure_model, t0 = t[-1], t1 = 2050, dt = 0.25, x0 = x1[-1], pars = [0, 0, p[0], p[1], p[2], p[3]], future_prediction = 20000)
	...
	ax.legend(handles = [line1, line2, line3], labels = ['Current Production', 'Cease all production', 'Double current production'])

	ps = np.random.multivariate_normal(p, cov, 100)
	for pi in ps:
		tp1,xp1 = solve_pressure_ode(ode_pressure_model, t[0], t[-1], 0.25, -0.20629999999999882, pars = [0, 0, pi[0], pi[1], pi[2], pi[3]])
		tp2,xp2 = solve_pressure_ode(ode_pressure_model, t0 = tp1[-1], t1 = 2050, dt = 0.25, x0 = xp1[-1], pars = [0, 0, pi[0], pi[1], pi[2], pi[3]], future_prediction = 10000)
		tp3,xp3 = solve_pressure_ode(ode_pressure_model, t0 = tp1[-1], t1 = 2050, dt = 0.25, x0 = xp1[-1], pars = [0, 0, pi[0], pi[1], pi[2], pi[3]], future_prediction = 0)
		tp4,xp4 = solve_pressure_ode(ode_pressure_model, t0 = tp1[-1], t1 = 2050, dt = 0.25, x0 = xp1[-1], pars = [0, 0, pi[0], pi[1], pi[2], pi[3]], future_prediction = 20000)
